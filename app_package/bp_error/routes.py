...
def handle_404(err):
    ...
    logger_bp_error.info(f'@bp_error.app_errorhandler(404)<timestamp:{timestamp}>, err: {err}')
    logger_bp_error.info(f'- @bp_error.app_errorhandler(404)<timestamp:{timestamp}>, request.referrer: {request.referrer}')
    logger_bp_error.info(f'- @bp_error.app_errorhandler(404)<timestamp:{timestamp}>, request.url: {request.url}')
